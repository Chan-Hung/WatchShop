...
<head>
    ...
    <title>WatchShop | Chỉnh sửa sản phẩm</title>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <form action="watch" method="post">
                                        <input type="hidden" name="action" value="editWatch">
                                    <div class="mb-3">
...
<%--                                        </span>--%>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="7" name="description" value="${product.description}"><c:out value = "${product.description}"/></textarea>
                                    </div>
                                    <div class="mb-3">
...
<%--                                        <span type="text" rows="7" class="form-control">--%>
